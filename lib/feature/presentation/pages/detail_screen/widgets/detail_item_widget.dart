...
class DetailItemWidget extends StatelessWidget {
  const DetailItemWidget({super.key});
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            const Text('29.11.2022', style: AppConstants.textLightGreyw400s16),
            IconButton(
              onPressed: () {},
        ...
        const Padding(
          ...
          child:
              Text('Заголовок новости', style: AppConstants.textBlackw500s24),
        ),
        const Text(
